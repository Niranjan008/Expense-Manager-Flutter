...
class PaymentDatabaseHelper {
  ...
  static final _databaseName = "PaymentManagerDatabase.db";
  static final _databaseVersion = 1;

  static final table = 'payment_table';

  static final columnId = '_id';
  static final columnPaymentName = 'paymentname';
  ...
  Future _onCreate(Database db, int version) async {
    await db.execute('''
          CREATE TABLE $table (
            ...
            $columnPaymentName TEXT NOT NULL
          )
          ''');
  }
